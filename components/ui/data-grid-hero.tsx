...
// TypeScript-only type for the props below; runtime validation still
// comes from PropTypes at the bottom of this file (preserved verbatim
...
export default function DataGridHero({
  ...
  useEffect(() => {
    ...
    container.style.setProperty("--mouse-glow-opacity", String(mouseGlow ? 1 : 0));
