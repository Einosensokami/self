  ...
  return <div id="top" className="relative overflow-hidden bg-[#f7f3ec] text-[#1e2a38]">
    ...
    <main className="relative z-10">
      ...
      <div className="mt-10 flex gap-3 lg:col-span-12">
        ...
        <a href="https://www.facebook.com/永恆戰神" target="_blank" rel="noreferrer" className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#1e2a38] text-white transition hover:bg-[#db6049]" title="Facebook">
