  ...
  return <div id="top" className="relative overflow-hidden bg-[#f7f3ec] text-[#1e2a38]">
    ...
    <main className="relative z-10">
      ...
      <div className="mt-10 flex gap-3 lg:col-span-12">
        <a href="https://www.instagram.com/Einosensokami" target="_blank" rel="noreferrer" className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#1e2a38] text-white transition hover:bg-[#db6049]" title="Instagram">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
        </a>
        <a href="https://www.facebook.com/einosensokami" target="_blank" rel="noreferrer" className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#1e2a38] text-white transition hover:bg-[#db6049]" title="Facebook">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
        </a>
        <div className="group relative flex h-12 w-12 items-center justify-center rounded-2xl bg-[#1e2a38] text-white transition hover:bg-[#db6049]" title="LINE ID">
          ...
          <span className="pointer-events-none absolute -top-9 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-lg bg-[#1e2a38] px-3 py-1.5 text-xs text-white opacity-0 transition group-hover:opacity-100">john0913666</span>
        </div>
      </div>
    </div></section>
    </main>
