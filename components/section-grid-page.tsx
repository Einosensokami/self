...
import { ArrowDownRight, ArrowUpRight, ExternalLink, Mail, MessageCircle, Instagram, Facebook } from "lucide-react";
  ...
  return <div id="top" className="relative overflow-hidden bg-[#f7f3ec] text-[#1e2a38]">
    ...
    <main className="relative z-10">
      ...
      <div className="mt-10 flex gap-3 lg:col-span-12">
        <a href="https://www.instagram.com/Einosensokami" target="_blank" rel="noreferrer" className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#1e2a38] text-white transition hover:bg-[#db6049]" title="Instagram"><Instagram size={20} /></a>
        <a href="https://www.facebook.com/永恆戰神" target="_blank" rel="noreferrer" className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#1e2a38] text-white transition hover:bg-[#db6049]" title="Facebook"><Facebook size={20} /></a>
        <div className="group relative flex h-12 w-12 items-center justify-center rounded-2xl bg-[#1e2a38] text-white transition hover:bg-[#db6049]" title="LINE ID"><MessageCircle size={20} /><span className="pointer-events-none absolute -top-9 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-lg bg-[#1e2a38] px-3 py-1.5 text-xs text-white opacity-0 transition group-hover:opacity-100">john0913666</span></div>
      </div>
    </div></div></section>
    </main>
